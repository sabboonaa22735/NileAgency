        ...
        <div className={`relative rounded-[2rem] overflow-hidden ${isDark ? 'bg-gray-900/80 backdrop-blur-2xl border border-white/10 shadow-2xl shadow-black/50' : 'bg-white/90 backdrop-blur-2xl border border-black/5 shadow-2xl shadow-blue-500/10'}`}>
          ...
          <div className="relative p-6 sm:p-8 pt-20 sm:pt-24">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              ...
              <a href="/api/auth/google" rel="noopener noreferrer" target="_self" className={`relative block w-full py-3 sm:py-4 rounded-xl sm:rounded-2xl font-medium text-sm sm:text-base text-center transition-all overflow-hidden group ${isDark ? 'bg-white/5 border border-white/10 hover:bg-white/10' : 'bg-white/80 border border-gray-200 hover:bg-gray-50'}`}>
